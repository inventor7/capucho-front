...
export const useDataTable = <TData>(config: DataTableConfig = {}) => {
  // Core state
  ...
  const pagination = ref<PaginationState>({
    pageIndex: 0,
    pageSize: tableConfig.defaults.pageSize,
  })
  ...
  const features = {
    enableSorting: tableConfig.features.sorting,
    enableFiltering: tableConfig.features.filtering,
    enableGrouping: tableConfig.features.grouping,
    enableAggregating: tableConfig.features.aggregating,
    enablePinning: tableConfig.features.columnPinning,
    enableColumnOrdering: tableConfig.features.columnOrdering,
    enableRowSelection: tableConfig.features.selection,
    enablePagination: tableConfig.features.pagination,
    enableVirtualization: tableConfig.features.virtualization,
    ...config,
  }

  // UI state
  const density = ref<'compact' | 'normal' | 'comfortable'>(tableConfig.defaults.density)
